...
export const BtnLoss = ({ btnIniciarClicked, btnEditarClicked }) => {
	...
	const { operaciones, perdedoras, capitalActual, capitalInicial, riesgo, distanciaProfit } = stats
	...
	return (
		<button className="btn-loss" onClick={clickBtnLoss}>
			Loss
		</button>
	)
}
